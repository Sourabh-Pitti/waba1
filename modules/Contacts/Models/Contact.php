...
class Contact extends Model
{
     ...
     */
public function updateLastReply($is_message_by_contact)
{
...
{
    // Check if the message is from contact and fb_message_id is set
    ...
    // Update the contact's last message details
    $this->has_chat = true;
    $this->updateLastReply($is_message_by_contact);
